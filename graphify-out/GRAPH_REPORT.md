...
## Corpus Check
- 72 files · ~90,894 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 681 nodes · 846 edges · 61 communities (31 shown, 26 thin omitted)
...
Cohesion: 0.07
Nodes (35): LocalDataSource, RemoteDataSource, connectivityResult, getMessages, localDataSource, MessageRepository, remoteDataSource, connectivityResult (+27 more)
...
Cohesion: 0.06
Nodes (33): int?, build, _checkboxValue, countries, _countryError, createState, dispose, _emailController (+25 more)
...
Cohesion: 0.11
Nodes (18): build, createState, _homeAppBar, _homeBody, HomeScreen, _HomeScreenState, imageUrl, label (+10 more)

### Community 10 - "remote_data_source.dart"
Cohesion: 0.06
Nodes (33): Dio, addUser, currentUserBaseUrl, _dio, getMessages, getPosts, getStories, getUserById (+25 more)

### Community 11 - "profile_screen.dart"
Cohesion: 0.06
Nodes (37): HomeProfile, NavigationBar, build, content, _editProfileButton, false, highlightImages, HighlightProfiles (+29 more)

### Community 12 - "directs_screen.dart"
Cohesion: 0.13
Nodes (14): Future, build, createState, _directsAppBar, _directsList, _footer, me, _messagesFuture (+6 more)
...
Cohesion: 0.20
Nodes (10): build, createState, handleProfileTap, index, Instagram, _InstagramState, me, package:instagram_clone/models/user_model.dart (+2 more)
...
### Community 49 - "State"
Cohesion: 0.32
Nodes (8): SplashScreen, _SplashScreenState, DirectsScreen, _DirectsScreenState, LoginScreen, _LoginScreenState, State, StatefulWidget
...
## Knowledge Gaps
- **361 isolated node(s):** `database`, `cacheMe`, `getMe`, `getPosts`, `cachePosts` (+356 more)
